...
<div class="wpjb wpjr-page-login">
    ...
    <form class="wpjb-form" action="" method="post">
        ...
        <fieldset>
            ...
            <input type="submit" name="wpjb_savenclose" class="wpjb-button" value="<?php _e("Save and close", "wpjobboard") ?>" />
            <a href="<?php esc_attr_e(wpjr_link_to("myresume")) ?>"><?php _e("Cancel and go back.", "wpjobboard") ?></a>
            </div>
        </fieldset>
